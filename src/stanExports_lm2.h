...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(8, 8, "include", "/include/sigma.stan");
    reader.add_event(8, 0, "start", "/include/sigma.stan");
    reader.add_event(9, 1, "end", "/include/sigma.stan");
    reader.add_event(9, 9, "restart", "model_lm2");
    reader.add_event(19, 17, "end", "model_lm2");
    return reader;
}
#include <stan_meta_header.hpp>
class model_lm2
  : public stan::model::model_base_crtp<model_lm2> {
private:
        int N;
        vector_d x;
        vector_d y;
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(student_t_log<propto__>(sigma, 4, 1, .5));
            if (sigma < 0) lp_accum__.add(-std::numeric_limits<double>::infinity());
            else lp_accum__.add(-student_t_ccdf_log(0, 4, 1, .5));
